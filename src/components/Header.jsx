...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-white dark:bg-gray-800 h-[72px] flex items-center justify-between px-4 md:px-8 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
        <div className="flex items-center">
          <HamburgerButton />
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Welcome, {username}</h2>
        </div>
